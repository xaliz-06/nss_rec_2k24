      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="p-2 flex flex-col gap-2">
          <p className="text-sm font-normal tracking-tighter text-black md:text-base">
            The <span className="font-bold text-emerald-600">NSS SOEE</span>,
            under the School of Electronics Engineering, is a
            government-controlled organization that aims to develop
            students&apos; personalities through voluntary community service.
            Taking inspiration from the ideology of Mahatma Gandhi, its motto is{" "}
          ...
          <p className="text-sm font-normal tracking-tighter text-black  md:text-base">
            ...
            NSS SOEE PROJECT LAKSHYA primarily focuses on ground-level work,
            such as going from home to home to inspire and make people aware of
            their rights, organizing various campaigns on women&apos;s health
            and public safety, and distributing items like food and sanitary
            pads.{" "}
          </p>
          <p className="text-sm font-normal tracking-tighter text-black md:text-base">
